...
You may need to read code in the [UEPseudo](https://github.com/BlackBookOfficial/ue4ss-linux-palworld/tree/main/deps/first/Unreal) directory (more specifically, the `include/Unreal` directory) to understand how to use these functions.
